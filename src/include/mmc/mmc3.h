...
static INLINE void mmc3_reset (void)
{
    ...
    mmc3_cpu_bank[0] = 0;
    mmc3_cpu_bank[1] = 1;
    cpu_set_read_address_8k_rom_block (0x8000, mmc3_cpu_bank[0]);
    cpu_set_read_address_8k_rom_block (0xA000, mmc3_cpu_bank[1]);
