...
static INLINE void blit_2xscl_8 (BITMAP * source, BITMAP * target, int x, int y)
{
    int x_base;
...
static INLINE void blit_2xscl_16 (BITMAP * source, BITMAP * target, int x, int y)
{
    int x_base;
    ...
    for (y_offset = 0; y_offset < source -> h; y_offset ++)
    {
        ...
        for (x_offset = 0; x_offset < source -> w; x_offset ++)
        {
            ...
            {
                west_pixel = palette_color [FAST_GETPIXEL8 (source, (x_offset - 1), y_offset)];
            }
...
static INLINE void blit_2xscl_32 (BITMAP * source, BITMAP * target, int x, int y)
{
    int x_base;
...
static INLINE void blit_2xscl (BITMAP * source, BITMAP * target, int x, int y)
{
    switch (color_depth)
    {
        case 8:
            ...
            blit_2xscl_8 (source, target, x, y);
        ...
        case 16:
            ...
            blit_2xscl_16 (source, target, x, y);
        ...
        case 32:
            ...
            blit_2xscl_32 (source, target, x, y);
