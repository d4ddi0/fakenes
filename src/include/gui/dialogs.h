...
static const DIALOG help_fakenes_team_dialog_base[] =
{
   ...
   { sl_text,     18,  46,  0,   0,   0, 0, 0, 0,      0, 0, NULL, "TRAC",               NULL },
   { sl_text,     18,  55,  0,   0,   0, 0, 0, 0,      0, 0, NULL, "Lord_Nightmare",     NULL },
   { sl_text,     18,  64,  0,   0,   0, 0, 0, 0,      0, 0, NULL, "KittyCat",           NULL },
   { sl_text,     9,   76,  0,   0,   0, 0, 0, 0,      0, 0, NULL, "Contributors:",      NULL },
   { sl_text,     18,  85,  0,   0,   0, 0, 0, 0,      0, 0, NULL, "ipher",              NULL },
   { sl_text,     18,  94,  0,   0,   0, 0, 0, 0,      0, 0, NULL, "amit",               NULL },
   ...
   { sl_text,     18,  133, 0,   0,   0, 0, 0, 0,      0, 0, NULL, "RobotBebop",         NULL },
   ...
   { sl_text,     128, 118, 0,   0,   0, 0, 0, 0,      0, 0, NULL, "rOss",               NULL },
