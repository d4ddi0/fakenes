...
{                                                           
   ...
   { sl_text,       144, 49,  0,   0,   0, 0, 0,   0,      0,   0, NULL,              "&Gamma:",            NULL },
   { d_slider_proc, 153, 58,  117, 5,   0, 0, 'g', 0,      200, 0, NULL,              NULL,                 NULL },
   { sl_text,       144, 70,  0,   0,   0, 0, 0,   0,      0,   0, NULL,              "&Resolution:",       NULL },
   { d_slider_proc, 153, 79,  117, 5,   0, 0, 'r', 0,      200, 0, NULL,              NULL,                 NULL },
   { sl_text,       144, 91,  0,   0,   0, 0, 0,   0,      0,   0, NULL,              "C&olor Bleed:",      NULL },
   { d_slider_proc, 153, 100, 117, 5,   0, 0, 'o', 0,      200, 0, NULL,              NULL,                 NULL },
   { sl_text,       144, 112, 0,   0,   0, 0, 0,   0,      0,   0, NULL,              "Ar&tifacts:",        NULL },
   { d_slider_proc, 153, 121, 117, 5,   0, 0, 't', 0,      200, 0, NULL,               NULL,                NULL },
   { sl_text,       144, 133, 0,   0,   0, 0, 0,   0,      0,   0, NULL,              "Fri&nging:",         NULL },
...
enum
{
   ...
   NES_NTSC_CONFIG_DIALOG_UNNAMED_OBJECT_10,
   NES_NTSC_CONFIG_DIALOG_GAMMA,
   NES_NTSC_CONFIG_DIALOG_UNNAMED_OBJECT_11,
   NES_NTSC_CONFIG_DIALOG_RESOLUTION,
   NES_NTSC_CONFIG_DIALOG_UNNAMED_OBJECT_12,
   NES_NTSC_CONFIG_DIALOG_COLOR_BLEED,
   NES_NTSC_CONFIG_DIALOG_UNNAMED_OBJECT_13,
   NES_NTSC_CONFIG_DIALOG_ARTIFACTS,
   NES_NTSC_CONFIG_DIALOG_UNNAMED_OBJECT_14,
   NES_NTSC_CONFIG_DIALOG_FRINGING,
   NES_NTSC_CONFIG_DIALOG_REDUCE_FLICKER,
   NES_NTSC_CONFIG_DIALOG_UNNAMED_OBJECT_15,
   NES_NTSC_CONFIG_DIALOG_SCANLINE_DOUBLING_NORMAL,
   NES_NTSC_CONFIG_DIALOG_SCANLINE_DOUBLING_BRIGHTEN,
   NES_NTSC_CONFIG_DIALOG_SCANLINE_DOUBLING_DARKEN,
   NES_NTSC_CONFIG_DIALOG_INTERPOLATED,
   NES_NTSC_CONFIG_DIALOG_UNNAMED_OBJECT_16,
   NES_NTSC_CONFIG_DIALOG_PRESETS_DEFAULT,
   NES_NTSC_CONFIG_DIALOG_PRESETS_COMPOSITE,
   NES_NTSC_CONFIG_DIALOG_PRESETS_SVIDEO,
   NES_NTSC_CONFIG_DIALOG_PRESETS_RGB,
   NES_NTSC_CONFIG_DIALOG_PRESETS_MONOCHROME,
   NES_NTSC_CONFIG_DIALOG_SET_BUTTON,
