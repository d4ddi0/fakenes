...
// Internal RAM. This can be replaced in pages through memory mapping.
UINT8 cpu__ram[CPU_RAM_SIZE];
// External RAM, usually present on the cartridge.
UINT8 cpu__sram[CPU_SRAM_SIZE];
