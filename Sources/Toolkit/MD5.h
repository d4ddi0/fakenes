...
#include "Common/Types.h"	/* For UINT8 and UINT32. */
...
typedef union _MD5_HASH {
  MD5_WORDS words;
  UINT8 bytes[16]; /* Should be the same as MD5_SIZE below. */
  
} MD5_HASH;

/* Wrapper function - defined in 'MD5.c'. */
extern MD5_HASH calculate_md5(const void* buffer, const size_t size);
