...
static void ffe_f3_save_state(PACKFILE*, const int);
static void ffe_f3_load_state(PACKFILE*, const int);
...
static void ffe_f3_save_state(PACKFILE* file, const int version)
{
   RT_ASSERT(file);
...
static void ffe_f3_load_state(PACKFILE* file, const int version)
{
   RT_ASSERT(file);
